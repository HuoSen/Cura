...
class simpleModePanel(wx.Panel):
	...
	def __init__(self, parent, callback):
		...
		self.printTypeHigh = wx.RadioButton(printTypePanel, -1, '高品质', style=wx.RB_GROUP)
		self.printTypeNormal = wx.RadioButton(printTypePanel, -1, '普通质量')
		self.printTypeLow = wx.RadioButton(printTypePanel, -1, '高速低质量')
		self.printTypeJoris = wx.RadioButton(printTypePanel, -1, '薄壁杯子/罐子')
		...
		self.printSupport = wx.CheckBox(self, -1, '打印支撑结构')

		sizer = wx.GridBagSizer()
		self.SetSizer(sizer)

		sb = wx.StaticBox(printTypePanel, label="选择打印类型:")
